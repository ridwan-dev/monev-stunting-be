            ...
            <div class="card p-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        {{ csrf_field() }}
                        <h1>{{ env('APP_NAME', 'Stunting CPanel') }}</h1>
                        <img src="{{ asset('/images/login-logo.jpg') }}" style="width: 120px; float: right; margin-top: -45px;"/>
                        <img src="{{ asset('/images/icon-logo.png') }}" style="width: 50px; float: right; margin-top: -45px; margin-right: 20px;"/>
