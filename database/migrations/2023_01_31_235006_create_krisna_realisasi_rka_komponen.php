...
class CreateKrisnaRealisasiRkaKomponen extends Migration
{
    private $table = 'versi_tiga.krisna_realisasi_rka_komponen';
    ...
    public function up()
    {
        Schema::create($this->table, function (Blueprint $table) {
            $table->increments('id');            
            $table->string('rka_komp_kode', 30)->nullable();            
            ...
            $table->unsignedInteger('alokasi')->nullable();
            $table->string('komponen_kode', 10)->nullable();
            $table->string('komponen_nama', 10)->nullable();
            $table->string('sumber_dana_id', 10)->nullable();
